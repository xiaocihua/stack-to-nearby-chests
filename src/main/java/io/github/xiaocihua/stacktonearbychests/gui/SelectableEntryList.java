...
public class SelectableEntryList<D> extends WClippedPanelCustom {
	...
	public static abstract class Entry<D> extends WWidget {
		...
		private static final BackgroundPainter UNSELECTED = BackgroundPainter.createNinePatch(ResourceLocation.fromNamespaceAndPath(MOD_ID, "textures/background_dark.png"));
		private static final BackgroundPainter SELECTED = BackgroundPainter.createNinePatch(new Texture(ResourceLocation.fromNamespaceAndPath(MOD_ID, "textures/background_dark_selected.png")),
