...
public class WTabPanelCustom extends WPanel {
    ...
    final static class Painters {
        static final BackgroundPainter SELECTED_TAB =
                BackgroundPainter.createNinePatch(new Texture(ResourceLocation.fromNamespaceAndPath(ModOptions.MOD_ID, "textures/selected_tab.png")),
                        builder -> builder.mode(NinePatch.Mode.STRETCHING).cornerSize(4).cornerUv(0.25f));
        static final BackgroundPainter UNSELECTED_TAB =
                BackgroundPainter.createNinePatch(ResourceLocation.fromNamespaceAndPath(ModOptions.MOD_ID, "textures/background_dark.png"));
    }
