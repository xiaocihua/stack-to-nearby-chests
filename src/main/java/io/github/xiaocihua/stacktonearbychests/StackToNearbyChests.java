...
import io.github.xiaocihua.stacktonearbychests.mixin.AbstractMountInventoryScreenMixin;
...
public class StackToNearbyChests implements ClientModInitializer {
    ...
    public static boolean isContainerScreen(Screen screen) {
        if (!(screen instanceof AbstractContainerScreen<?>)) {
            ...
            return ((AbstractMountInventoryScreenMixin) screen).getMount() instanceof AbstractChestedHorse abstractDonkeyEntity
