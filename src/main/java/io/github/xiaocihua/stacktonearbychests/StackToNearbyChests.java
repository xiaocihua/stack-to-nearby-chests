...
import io.github.xiaocihua.stacktonearbychests.mixin.AbstractMountInventoryScreenAccessor;
...
public class StackToNearbyChests implements ClientModInitializer {
    ...
    private static final Identifier BUTTON_TEXTURES = Identifier.fromNamespaceAndPath(ModOptions.MOD_ID, "widget/");
    ...
    public static boolean isContainerScreen(Screen screen) {
        if (!(screen instanceof AbstractContainerScreen<?>)) {
            ...
            return false;
        } else if (screen instanceof AbstractMountInventoryScreen) {
            return ((AbstractMountInventoryScreenAccessor) screen).getMount() instanceof AbstractChestedHorse abstractDonkeyEntity
