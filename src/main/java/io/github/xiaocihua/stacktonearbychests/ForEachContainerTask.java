...
public abstract class ForEachContainerTask {
    ...
    public static void init() {
        ...
        ReceiveGameMessageCallback.EVENT.register((message, overlay) -> {
            if (isRunning()
    ...
    public void onInventory(ScreenHandler screenHandler) {
        if (StackToNearbyChests.IS_PLAYEREX_MOD_LOADED
                && "com.github.clevernucleus.playerex.factory.ExScreenFactory.Handler"
                .equals(screenHandler.getClass().getCanonicalName())) {
            return;
        }
